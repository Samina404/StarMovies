        ...
        <footer className="px-6 mt-40 md:px-16 lg:px-36 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
                <div className="md:max-w-96">
                    <img alt="" class="h-30 w-50" src={assets.clogo}/>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+88 01815432967</p>
                            <p>StarCinema@example.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">StarCinema</a>. All Right Reserved.
            </p>
        </footer>
    )
}
